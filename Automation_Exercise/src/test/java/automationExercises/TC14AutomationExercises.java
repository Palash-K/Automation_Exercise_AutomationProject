...
public class TC14AutomationExercises {
    ...
    public void test1() throws AWTException, InterruptedException {
        ...
        WebElement cartPage = driver.findElement(By.id("product-1"));
        ...
        name.sendKeys("adminUser121");
        WebElement email = driver.findElement(By.xpath("//input[@data-qa='signup-email']"));
        email.sendKeys("adminUser121@mail.com");
